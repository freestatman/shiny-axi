---
name: shiny-axi
description: Route visual review of R Shiny and Quarto work through shiny-axi. Use when the user asks to launch, annotate, or visually inspect a Shiny app or rendered Quarto document.
