...
The committed `skills/shiny-axi/SKILL.md` is generated by `pnpm run build:skill`; `pnpm run check` fails if it drifts from its generator in `src/skill.js`.
