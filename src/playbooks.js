...
export const PLAYBOOKS = [
  {
    ...
    shiny_axi_notes: [
      "A Shiny AXI diagram should invite precise annotation: make modules, edges, and captions easy to click and discuss.",
  ...
  },
  {
    ...
    shiny_axi_notes: [
      "A Shiny AXI table should make individual rows easy annotation targets.",
  ...
  },
  {
    ...
    shiny_axi_notes: [
      "A Shiny AXI comparison should let the user annotate the exact option or tradeoff they want changed.",
  ...
  },
  {
    ...
    shiny_axi_notes: ["A Shiny AXI plan should make a plan and its uncertainties easy to annotate before code exists."],
  },
  {
    id: "code",
    use_when: "Render source code, code files, patches, PR diffs, and before/after code inside Shiny AXI artifacts",
    choose: [
...
\`\`\``,
    ...
    shiny_axi_notes: [
      "A Shiny AXI code artifact should make each file, hunk, and relevant line easy to annotate precisely.",
  ...
  },
  {
    ...
    design_rules: [
      ...
      "Put data-lavish-action only on custom (non-native) elements that should act like a feedback control - typically a styled div or span you made clickable - so Shiny AXI does not annotate it and shows a pointer cursor instead.",
    ...
    shiny_axi_notes: [
      "Shiny AXI is strongest when the artifact becomes a focused review surface and not just a static page.",
  ...
  },
  {
    ...
    shiny_axi_notes: [
      "A Shiny AXI slide deck can still collect feedback, but each prompt should refer to a slide or decision.",
